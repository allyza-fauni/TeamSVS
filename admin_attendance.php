...
<div class="container" style="margin-top:30px">
  <div class="card">
      ...
      <div class="row">
        <div class="col-md-9"><h2><b><i>Regular Members Attendance List</i></b></h2></div>
...
$(document).ready(function(){
  ...
  var dataTable = $('#attendance_table').DataTable({
    ...
    "order":[],
    "ajax":{
      url:"admin_attendance_action.php",
      type:"POST",
      data:{action:'fetch'}
    }
  });
  ...
  $('#create_report').click(function(){
    ...
    if(error == 0)
    {
      ...
      window.open("report.php?action=attendance_report&svs_id="+svs_id+"&from_date="+from_date+"&to_date="+to_date);
    }
  ...
  $('#create_chart').click(function(){
    ...
    if(error == 0)
    {
      ...
      $('#chart_svs_id').val('');
      $('#chartModal').modal('show');
      window.open("chart1.php?action=attendance_report&svs_id="+svs_id+"&date="+attendance_date);
    }
