...
<?php
$query = "
SELECT * FROM tbl_svs WHERE svs_id = (SELECT member_svs_id FROM tbl_member 
    ...
    <form method="post" id="attendance_form">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group" id="dupmember_details">
            <div class="table-responsive">
              <table class="table table-striped table-bordered">
                ...
                $sub_query = "
                  ...
                  WHERE dupmember_svs_id = '".$row["svs_id"]."'
                ";
                $statement = $connect->prepare($sub_query);
                $statement->execute();
                $dupmember_result = $statement->fetchAll();
                foreach($dupmember_result as $dupmember)
                {
                ?>
                  <tr>
                    <td>
                      <?php echo $dupmember["dupmember_name"]; ?>
                      <input type="hidden" name="dupmember_id[]" value="<?php echo $dupmember["dupmember_id"]; ?>" />
                    </td>
                    <td>
                      <input type="radio" name="attendance_status<?php echo $dupmember["dupmember_id"]; ?>" value="Present" />
                    </td>
                    <td>
                      <input type="radio" name="attendance_status<?php echo $dupmember["dupmember_id"]; ?>" checked value="Absent" />
                    </td>
                  </tr>
                <?php
                }
