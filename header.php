...
<div class="jumbotron-small text-center" style="color: #fff; font-family: Nunito, sans serif; background-color: #383080;">
  ...
  <h1>SVS MEMBER LOUNGE</h1>
</a>
</div>
<nav class="navbar navbar-expand-sm navbar-dark">
  <a class="navbar-brand" href="index.php"><img src="img/home.png"></a>
              <a href="profile.php" target="" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span style="color: #383080.#383080;">Profile </span>
                <i class="bi bi-person-fill"></i>
              </a>
              <a href="index.php#forms" target="" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
