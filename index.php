    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1>Welcome to your special suite! 
          </h1>
          ...
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
              <a href="attendance.php" target="_blank" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span>Check Attendance</span>
                <i class="bi bi-calendar-check"></i>
              </a>
              <a href="attendance_progress.php" target="_blank" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
...
function initSlideShow(slideshow) {
  ...
  setInterval( () => {
    ...
    slides[index].classList.add('active'); }, time);
}
</script>